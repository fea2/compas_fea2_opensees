...
from compas_fea2.problem import LoadCombination, DisplacementFieldOutput, ReactionFieldOutput
...
# =============================================================================
n1 = Node(name='N1', xyz=(0.,       0.,     0.))
n2 = Node(name='N2', xyz=(144.0,    0.,     0.))
n3 = Node(name='N3', xyz=(168.0,    0.,     0.))
n4 = Node(name='N4', xyz=(72.0,     96.0,   0.))
